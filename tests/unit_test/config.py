...
for data_item in combined_list:
    if (
        ...
        break
print(iam_role_resource_list_assumed_policy)
...
iam_role_most_expensive_service_role_assumed_policy = None
for data_item in combined_list:
    if (
        data_item["type"] == "aws_iam_role"
        and data_item["name"] == "most_expensive_service_role"
    ):
        iam_role_most_expensive_service_role_assumed_policy = data_item["values"][
            "assume_role_policy"
        ]
        break
